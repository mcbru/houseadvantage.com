...
<section class="[ band  band--special ]  text-center">
  <div class="row">
    <p>House Advantage has deep strategic and operational experience managing enterprise-level loyalty marketing programs. Our powerful loyalty solutions help international brands increase customer engagement, generate vital business intelligence and boost share-of-wallet.</p>
    <p>Our technologies don’t displace existing systems – they integrate with them. Informed by decades of experience, we deliver loyalty strategy, consulting services, and integration tools that help our clients build stronger bonds with their own customers Our loyalty solutions consolidate spend and fuel revenue growth.  House Advantage works as an ongoing strategic partner to ensure the success and maximum value of your loyalty programs.</p>
    <h2>Our Loyalty Solutions Will Boost Patron Engagement</h2>
    <p>In today’s highly dynamic resort, leisure and entertainment markets, operators like you must build stronger customer connection. You need meaningful ways to differentiate your offerings and build and drive greater revenue profitability. The best way to do this is by enhancing the patron experience through a robust, integrated loyalty program – a proven way to gain a competitive edge and deliver bottom line results.</p>
...
-->
  ...
  <div class="small-12  medium-6  column">
    <div class="nugget-group  text-left">
      <div class="nugget__item">
        <h3>Empower patrons to redeem offers and rewards their own</h3>
        <p>Let customers manage experiences through a variety of self-service interfaces.</p>
      </div>

      <div class="nugget__item">
        <h3>Enable the creation and execution of new programs</h3>
        <p>Offer campaigns through a suite of advanced loyalty marketing capabilities.</p>
      </div>
...
<section class="[ band  band--special-dark ]  text-center">
  <div class="row">
    ...
    <p><strong>House Advantage</strong> offers deep-bench strength in loyalty marketing and technology strategy services to support your loyalty programs with IT support and consulting expertise built on best practices for the resort, leisure and entertainment market.</p>
    <div class="nugget-group  animation-wrapper">
      <div class="nugget__item  small-12  medium-6  column">
        ...
        <p>HALo is a suite of centrally managed loyalty solutions that can integrate and incorporate your loyalty program across hotel, restaurant, point of sale, food and beverage, and entertainment systems in service of a coherent, enterprise-wide customer experience.</p>
      ...
      <!--   </span> -->
        ...
        <p><strong>House Advantage</strong> offers certified tools for point-to-point and information-bus integrations, with deep expertise deploying HALo on legacy infrastructures to preserve your existing technology investments.</p>
...
<section class="[ band  band--large ]  text-center">
  <div class="row">
    ...
    <a role="button" class="large  button  hvr-sweep-to-right" href="about">meet the ha team</a>
  </div>
</section>
