...
-->
    ...
    <p>HALo is a comprehensive suite of loyalty solutions that will help you differentiate and extend your offerings to gain competitive advantage in highly dynamic markets.</p>
  ...
  <div class="row">
    <div class="small-12  medium-4  column">
      <div class="nugget-group  text-left">
        <div class="nugget__item">
          <h3 class="delta">Extend the value of your current investments</h3>
          <p>Seamlessly integrate HALo loyalty solutions with existing systems.</p>
        </div>

        <div class="nugget__item">
          <h3 class="delta">Incorporate patron data universally</h3>
          <p>Provide a consistent experience across all existing transactional systems.</p>
        </div>

        <div class="nugget__item">
          <h3 class="delta">Expand the value proposition of your program</h3>
    ...
    <div class="small-12  medium-4  column">
      <div class="nugget-group  text-left">
        <div class="nugget__item">
          <h3 class="delta">Empower patrons to redeem offers and rewards when they want</h3>
          <p>Let customers manage experiences through a variety of self-service interfaces.</p>
        </div>

        <div class="nugget__item">
          <h3 class="delta">Enable the creation and execution of new programs</h3>
