...
<section class="[ band  band--special ]  text-center">
  <div class="row">
    <p><strong>House Advantage</strong> has deep strategic and operational experience managing enterprise-level loyalty marketing programs. A powerful loyalty solution will help you increase customer engagement and generate vital business intelligence – and that's exactly what we offer. Get the House Advantage.</p>
    <p>Better still, our technologies integrates with your existing systems. No rip and replace required. We deliver the strategy, solution set and integration tools needed to build stronger bonds with your customers.</p>
...
<section class="[ band  band--special-dark  band--large ]  text-center">
  <div class="row">
    ...
    <p class="lede"><strong>House Advantage</strong> offers decades of experience in loyalty programs for the resort, leisure and entertainment markets. We bring proven technology and the strategic expertise needed to enhance your loyalty program. We offer ongoing services support after we implement your solution.</p>
  </div>
